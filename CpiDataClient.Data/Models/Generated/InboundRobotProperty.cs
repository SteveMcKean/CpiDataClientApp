...
public partial class InboundRobotProperty
{
    ...
    public virtual RobotConfigurationProfile RobotConfigurationProfile { get; set; } = null!;

    public virtual VisionPickMode VisionPickModeNavigation { get; set; } = null!;
}
